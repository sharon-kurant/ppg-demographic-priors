    ...
    return pd.DataFrame(
        {
            ...
            "contract_version": ["source-faithful-v2"] * 4,
        }
    )
    ...
    return pd.DataFrame(
        {
            ...
            "y_pred_mmhg": [120.0] * 5,
            "contract_version": ["source-faithful-v2"] * 5,
        }
    )
            ...
            pd.DataFrame(
                {
                    ...
                    "contract_version": ["source-faithful-v2"] * 2,
                }
            )
        )
    ...
    rows = pd.DataFrame(
        {
            ...
            "contract_version": ["source-faithful-v2"] * 14,
        }
    )
...
def test_checked_units_rejects_wrong_contract() -> None:
    ...
    with pytest.raises(ValueError, match="requires source-faithful-v2"):
    ...
    raw = pd.DataFrame(
        {
            ...
            "contract_version": ["source-faithful-v2"] * 6,
        }
    )
